...
public class LeftPitch extends Subsystem {
    // BOILERPLATE
    public static final LeftPitch INSTANCE = new LeftPitch();
    private LeftPitch() { }
    ...
    public void initialize() {
        servo = OpModeData.INSTANCE.getHardwareMap().get(Servo.class, Outtake.outtakeLPitch);
    }
}